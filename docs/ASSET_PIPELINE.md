...
One asset builds in well under a second after Blender starts, and the full set of 112 in about 16 s. Output bytes are reproducible: two builds of an unchanged entry give identical FBX and PNG files.
