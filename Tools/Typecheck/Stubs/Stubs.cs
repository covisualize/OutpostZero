...
namespace UnityEngine.Rendering.Universal
{
    ...
    public class UniversalRenderPipelineAsset : RenderPipelineAsset { public static UniversalRenderPipelineAsset Create(ScriptableRendererData rendererData = null) { return null; } protected override RenderPipeline CreatePipeline() { return null; } public int msaaSampleCount { get; set; } public float renderScale { get; set; } public float shadowDistance { get; set; } public int mainLightShadowmapResolution { get; set; } public int shadowCascadeCount { get; set; } public bool supportsHDR { get; set; } public bool supportsCameraDepthTexture { get; set; } public bool useSRPBatcher { get; set; } }
}
